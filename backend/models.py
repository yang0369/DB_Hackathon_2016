...
class MatchAnalysis(BaseModel):
    ...
    job_id: str
    job_title: str
    match_score: float = Field(description="Overall match percentage (0 to 100)")
    ...
    hr_recommendation: str = Field(description="AI recommendation rationale for HR (Highly Recommended, Consider, Skip)")
